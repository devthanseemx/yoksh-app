...
<div id="overview-content" class="space-y-8 animate-fadeIn">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <span class="text-sm font-medium text-slate-500">Last synced: <?php echo date('h:i A'); ?></span>
                    ...
                    ?>
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm font-medium text-slate-700"><?php echo $row['module_title']; ?></span>
                ...
                <div class="space-y-6 relative before:absolute before:left-3.5 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-100">
                    ...
                    ?>
                        <div class="relative pl-8">
                            ...
                            <p class="text-sm font-semibold text-slate-700 line-clamp-1"><?php echo $act['activity_description']; ?></p>
