...
<div class="mx-auto animate-fadeIn pb-20">
    <!-- Header Section -->
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 bg-white p-6 rounded-md border border-slate-100 shadow-sm">
        <div>
    ...
    <div id="progress-accordion" class="space-y-4">
        ...
        <?php else: ?>
            <div class="col-span-full py-20 bg-white border-2 border-dashed border-slate-200 rounded-md text-center animate-fadeIn">
                ...
                <!-- Title -->
                <h3 class="text-slate-600 font-bold text-lg">No Curriculum Available</h3>

                <!-- Description -->
                <p class="text-slate-400 text-sm mt-2 max-w-md mx-auto px-8 leading-relaxed">
                    We couldn't find any course structures to display. Please go to the
                    <span class="text-indigo-500 font-semibold">Curriculum Builder</span>
                    first to add modules, chapters, and sub-topics.
                </p>
            </div>
        <?php endif; ?>
